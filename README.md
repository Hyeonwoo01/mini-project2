...
![메인 KPI 화면](dashboard_01_main_kpi.png)

**2. [Tab 1] 전체 시장 데이터 (팩트 체크)**
> 서울시 전체 상권의 거주 인구와 유동 인구 불균형을 보여주는 표입니다. (통계적 이상치가 포함된 원본 데이터)
![데이터 테이블](dashboard_02_tab1_market_table.png)

**3. [Tab 2] 상권별 블루오션 지수 격차 (Top 10)**
> 유동인구(수요) 대비 경쟁 카페 수를 교차 연산한 '블루오션 지수'를 정렬형 가로 막대 차트로 직관적으로 비교합니다.
...
![시간대별 유동인구 추이](dashboard_04_tab3_hourly_trend.png)
